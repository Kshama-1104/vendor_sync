...
Service Flow implements multiple layers of security to protect data and ensure secure operations.
...
- **Manager**: Team and service management
...
- Requester-only access for private services
- Team-based access for shared services
